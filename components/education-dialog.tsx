...
export default function EducationDialog() {
	...
	return (
		<Dialog aria-modal="true">
			...
			>
									{/* Header row: title left, close right, minimal bottom margin */}
									<div className="flex items-center justify-between sticky top-0 z-10 bg-card mb-2" style={{marginBottom: '8px'}}>
										<DialogTitle
											id="education-title"
